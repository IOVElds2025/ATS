...
const ApplicationsCard = () => {
	...
	<div className="bg-white rounded-md shadow p-6 flex flex-col">
		...
		<span className="bg-blue-100 text-gray-700 px-4 py-1 rounded-sm text-sm font-medium">12 Active</span>
		</div>
	...
	return (
		<div className="bg-white rounded-md shadow p-6 flex flex-col">
			<div className="flex items-center justify-between mb-2">
				...
				<span className="bg-green-100 text-green-800 px-4 py-1 rounded-sm text-sm font-medium">85%</span>
			</div>
...
const JobMatchesCard = () => {

	return (
		<div className="bg-white rounded-md shadow p-6 flex flex-col">
			<div className="flex items-center justify-between mb-2">
				<h3 className="text-lg font-semibold">Job Matches</h3>
				<span className="bg-purple-100 text-purple-800 px-4 py-1 rounded-sm text-sm font-medium">New</span>
			</div>
			<div className="space-y-2 mt-2">
				<div className="flex justify-between items-center text-gray-700">
